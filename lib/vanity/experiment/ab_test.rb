...
module Vanity
  module Experiment
    ...
    class AbTest < Base
      ...
      #Call this method to set the percetage of users you wish to experiment
      # in a given ab_experiment, else it will be set to 100% i.e. all users
      #
      # @example Set the Test Percentage
      #   ab_test "Background color" do
      #     alternatives "red", "blue", "orange"
      #     default "red"
      #     test_percentage "50"
      #   end
      # @example Get the test percentage
      #   assert experiment(:background_color).test_percentage == "50"
      # TODO document test percentage if not explicitly given (100)
      #
      ...
      def test_percentage(value)
        ...
        class << self
          define_method :test_percentage, instance_method(:_test_percentage)
        end
        nil
      end

      def _test_percentage  #???? What should this mean?
        #alternative(@default)
      end
      private :_test_percentage
